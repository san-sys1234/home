...
const STORAGE="unser-zuhause-v120";
const LEGACY_STORAGE="unser-zuhause-v109";
const DAILY=[
...
function defaultState(){return {done:{},lastDone:{},postponed:{},custom:[],catalogEdits:{},catalogDates:{},catalogDeleted:{},todayExtras:[],completedDays:{},completedOpen:false,postponedOpen:false,chaos:false,sundayOptional:{},energyOffset:0,energySkipDay:"",energySeen:[],calendarYear:new Date().getFullYear(),todayPlanLock:{},todayPlanSnapshot:{}}}
function loadState(){
 let raw=null;
 ...
 s.catalogEdits=s.catalogEdits||{};s.catalogDates=s.catalogDates||{};s.catalogDeleted=s.catalogDeleted||{};
...
function plannerKey(){return "v131|"+String(state.__planRevision||0)+"|"+JSON.stringify(state.catalogDates||{})+"|"+CATALOG.length+"|"+Object.keys(state.lastDone||{}).length+"|"+Object.keys(state.catalogDeleted||{}).length+"|"+state.custom.length+"|"+JSON.stringify(state.catalogEdits||{})+"|"+JSON.stringify(state.postponed||{})}
...
function nextDue(x,ref=today){
 ...
 const override=state.catalogDates?.[x.key];
